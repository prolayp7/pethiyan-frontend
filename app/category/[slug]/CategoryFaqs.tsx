...
export default function CategoryFaqs({ faqs }: { faqs: CategoryFaq[] }) {
  ...
  return (
    <section className="bg-white py-8" aria-labelledby="category-faqs-heading">
      <Container>
        <div className="rounded-[30px] border border-slate-200/80 bg-white px-5 py-6 shadow-[0_18px_48px_rgba(15,23,42,0.08)] sm:px-6">
          <h2 id="category-faqs-heading" className="text-lg font-bold text-(--color-secondary) mb-4">
