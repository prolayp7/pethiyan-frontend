  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          background: "linear-gradient(180deg, #f8faff 0%, #f0f5ff 45%, #e8f2ff 80%, #dff0fa 100%)",
        }}
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `
              linear-gradient(rgba(46,124,138,0.12) 1px, transparent 1px),
              linear-gradient(90deg, rgba(46,124,138,0.12) 1px, transparent 1px),
              linear-gradient(rgba(60,130,255,0.08) 1px, transparent 1px),
        ...
        {/* Top-left corner glow — matches HeroSection10 background */}
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0"
          style={{
            background: "radial-gradient(ellipse 75% 75% at 0% 0%, rgba(7,16,35,0.72) 0%, rgba(10,22,48,0.50) 30%, rgba(12,29,56,0.22) 55%, transparent 80%)",
          }}
        />
