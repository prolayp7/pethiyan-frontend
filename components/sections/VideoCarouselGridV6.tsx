        ...
        <div className="mt-6 flex justify-center px-4">
          <a
            ...
            style={{
              ...
              boxShadow: "0 8px 32px rgba(0,0,0,0.35), 0 0 0 1px rgba(255,255,255,0.06) inset, 0 1px 0 rgba(255,255,255,0.25) inset",
              textDecoration: "none",
              animation: `${
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                boxShadow: "0 2px 8px rgba(0,0,0,0.2), 0 0 0 1px rgba(78,168,95,0.25)",
                flexShrink: 0,
              }}
            >
              <Image
            ...
            <div className="flex flex-col gap-0.5 min-w-0">
              <p
                ...
                style={{
                  backgroundImage: "linear-gradient(135deg, #1a4a8a 0%, #1e6fa0 60%, #2e7c8a 100%)",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                  backgroundClip: "text",
                }}
              ...
              <p
                ...
                style={{ color: "rgba(78,168,95,0.95)" }}
              >
