  ...
  return (
    <>
      ...
      <section className="w-full bg-white py-12 lg:py-20">
        ...
        {/* ── Fixed 5-slot row ────────────────────────────────────────── */}
        <div className="relative w-full flex items-center" style={{ height: SLOT_HEIGHT[0] + 40 }}>
        ...
        <div className="mt-6 flex justify-center px-4">
          <a
            ...
            className="flex items-center gap-4 bg-white rounded-2xl px-5 py-4 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow"
            style={{
              minWidth: 320,
              maxWidth: 420,
              animation: `${
