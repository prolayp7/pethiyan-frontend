  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          background: "linear-gradient(180deg, #060d1f 0%, #091528 40%, #0d2150 75%, #112a6b 100%)",
        }}
      >
        {/* Fine grid overlay */}
        <div
        ...
        <div
          ...
          className="pointer-events-none absolute inset-0"
          style={{
            background: "radial-gradient(ellipse 80% 40% at 50% 100%, rgba(17,60,160,0.35) 0%, transparent 70%)",
          }}
        />
